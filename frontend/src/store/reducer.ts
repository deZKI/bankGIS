...
import {bankBranchesReducer, IBankBranchesState} from "./bankBranches/bankBranchesReducer";
import {SetBankBranchesAction} from "./bankBranches/bankBranchesActions";
...
export interface IInitialState {
  ...
  client: IClientState;
  route: IRouteState;
  bankBranches: IBankBranchesState;
}
